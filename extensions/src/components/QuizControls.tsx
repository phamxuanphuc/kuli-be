...
export function QuizControls({ error, isScanning, onScanPage }: QuizControlsProps) {
  return (
    <section className="border border-black bg-white p-4 text-black shadow-[6px_6px_0_#111]" aria-label="Quiz generator controls">
      <div className="mb-4 flex items-start justify-between gap-4 border-b border-black pb-3">
        <div>
          ...
          <h2 className="mt-1 text-xl font-black uppercase leading-none tracking-[-0.04em]">Scan history</h2>
        </div>
      ...
      <div className="grid gap-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <Link
            className="grid h-12 place-items-center border border-black bg-white px-4 text-xs font-black uppercase tracking-[0.18em] text-black transition hover:-translate-y-0.5 hover:shadow-[4px_4px_0_#111]"
            to="/history"
          >
            View history
          </Link>
